...
class Defaults {
    ...
    // static let landscapeSnapAreas = JSONDefault<[Directional: SnapAreaConfig]>(
    //     key: "landscapeSnapAreas")
    // static let portraitSnapAreas = JSONDefault<[Directional: SnapAreaConfig]>(
    //     key: "portraitSnapAreas")
    static let missionControlDragging = OptionalBoolDefault(key: "missionControlDragging")
    nonisolated(unsafe) static let enhancedUI = IntEnumDefault<EnhancedUI>(
        key: "enhancedUI", defaultValue: .disableEnable)
    static let footprintAnimationDurationMultiplier = FloatDefault(
        key: "footprintAnimationDurationMultiplier", defaultValue: 0)
    static let hapticFeedbackOnSnap = OptionalBoolDefault(key: "hapticFeedbackOnSnap")
    static let missionControlDraggingAllowedOffscreenDistance = FloatDefault(
        key: "missionControlDraggingAllowedOffscreenDistance", defaultValue: 25)
    static let missionControlDraggingDisallowedDuration = IntDefault(
        key: "missionControlDraggingDisallowedDuration", defaultValue: 250)
    ...
    static let doubleClickTitleBarIgnoredApps = JSONDefault<[String]>(
        key: "doubleClickTitleBarIgnoredApps")
    static let doubleClickToolBarIgnoredApps = JSONDefault<Set<String>>(
        key: "doubleClickTitleBarIgnoredApps", defaultValue: ["epp.package.java"])
    ...
    static let systemWideMouseDownApps = JSONDefault<Set<String>>(
        key: "systemWideMouseDownApps",
        defaultValue: Set<String>(["org.languagetool.desktop", "com.microsoft.teams2"]))
    ...
    nonisolated(unsafe) static var array: [Default] = [
        launchOnLogin,
        disabledApps,
        hideMenuBarIcon,
...
class BoolDefault: Default, @unchecked Sendable {
...
class OptionalBoolDefault: Default, @unchecked Sendable {
    public private(set) var key: String
    private var initialized = false
...
class StringDefault: Default, @unchecked Sendable {
    public private(set) var key: String
    private var initialized = false
...
class FloatDefault: Default, @unchecked Sendable {
    public private(set) var key: String
    private var initialized = false
...
class IntDefault: Default, @unchecked Sendable {
    public private(set) var key: String
    private var initialized = false
...
class JSONDefault<T: Codable>: StringDefault, @unchecked Sendable {
